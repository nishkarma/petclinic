...
package org.nishkarma.demo.xmlmoxy.model;
...
public class Customer {
	...
	public boolean equals(Object obj) {
		...
		if (this.phoneNumbers != other.phoneNumbers
				&& (this.phoneNumbers == null || !this.phoneNumbers
	...
	public int hashCode() {
		...
		hash = 97
				* hash
				+ (this.phoneNumbers != null ? this.phoneNumbers.hashCode() : 0);
		return hash;
	}
}
